...
if [[ "$1" = "predict" ]]; then
    ...
    python3 routenet.py --ini config.ini predict --hparams="l2=0.1,dropout_rate=0.5,link_state_dim=32,path_state_dim=32,readout_units=256,learning_rate=0.001,T=8,node_count=50,predict_count=$3"  --predict ./nsfnet/$2/tfrecords/evaluate/*.tfrecords --model_dir ./Model
fi
